...
- **複数グループの一括編集**: 最大10グループを1つのモーダルで同時編集
- **動的グループ追加**: 「➕ グループの新規作成」ボタンで入力セット追加
- **完全同期**: モーダルの内容とFirestoreを自動同期（作成・更新・削除）
- グループごとのメンバー管理
- 管理者（レポート受信者）の設定
- Slackモーダルでの直感的な設定UI
